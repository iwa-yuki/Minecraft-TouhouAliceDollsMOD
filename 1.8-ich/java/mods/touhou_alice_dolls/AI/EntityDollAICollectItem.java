...
public class EntityDollAICollectItem extends EntityDollAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        // 蒐集対象探索
        List<EntityItem> itemList = (List<EntityItem>)(theWorld.getEntitiesWithinAABB(EntityItem.class, theDoll.getEntityBoundingBox().expand(searchRange, searchHeight, searchRange)));
    ...
    public void updateTask()
    {
        ...
        if(theDoll.getDistanceToEntity(theItem) < canCollectRange || catchCounter > 60)
        {
            ...
            {
                    theDoll.chatMessage(theDoll.getName() + " : Can't pick up!", 3);
                    theItem = null;
